...
class TestConfigurationsAPISpecializedMethods:
    ...
    async def test_get_by_organization(self, configurations_api, mock_http_client):
        ...
        with patch.object(configurations_api, '_process_response') as mock_process:
            ...
            mock_http_client.get.assert_called_once_with('/configurations', params=expected_params)
    ...
    async def test_update_status_with_enum(self, configurations_api, mock_http_client, sample_configuration_data):
        ...
        with patch.object(configurations_api, '_process_response') as mock_process:
            ...
            result = await configurations_api.update_status('123', ConfigurationStatus.INACTIVE)
    ...
    async def test_create_configuration_basic(self, configurations_api, mock_http_client, sample_configuration_data):
    ...
    async def test_create_configuration_full(self, configurations_api, mock_http_client, sample_configuration_data):
