...
class TestUsersAPI:
    ...
    @pytest.mark.asyncio
    async def test_get_by_email_found(self, users_api, mock_client, sample_users_list_data):
        ...
        with patch.object(users_api, 'list', new_callable=AsyncMock) as mock_list:
            ...
            mock_list.assert_called_once_with(params={"filter[email]": "john@example.com"}, page_size=1)
    ...
    async def test_get_by_email_not_found(self, users_api, mock_client):
        ...
        with patch.object(users_api, 'list', new_callable=AsyncMock) as mock_list:
            ...
            mock_list.assert_called_once_with(params={"filter[email]": "nonexistent@example.com"}, page_size=1)
    ...
    async def test_search_by_name(self, users_api, mock_client, sample_users_list_data):
        ...
        with patch.object(users_api, 'list', new_callable=AsyncMock) as mock_list:
            mock_users = [User.from_api_dict(data) for data in sample_users_list_data["data"]]
    ...
    @pytest.mark.asyncio
    async def test_search_by_name_with_collection(self, users_api, mock_client, sample_users_list_data):
    ...
    @pytest.mark.asyncio
    async def test_filter_by_role_string(self, users_api, mock_client, sample_users_list_data):
        """Test filtering users by role using string."""
        with patch.object(users_api, 'list', new_callable=AsyncMock) as mock_list:
            mock_users = [User.from_api_dict(sample_users_list_data["data"][0])]  # Admin user only
            mock_list.return_value = mock_users
    ...
    @pytest.mark.asyncio
    async def test_filter_by_role_enum(self, users_api, mock_client, sample_users_list_data):
        """Test filtering users by role using enum."""
        with patch.object(users_api, 'list', new_callable=AsyncMock) as mock_list:
            mock_users = [User.from_api_dict(sample_users_list_data["data"][1])]  # Editor user only
            mock_list.return_value = mock_users
    ...
    @pytest.mark.asyncio
    async def test_get_active_users(self, users_api, mock_client, sample_users_list_data):
    ...
    @pytest.mark.asyncio
    async def test_get_invited_users(self, users_api, mock_client, sample_users_list_data):
    ...
    @pytest.mark.asyncio
    async def test_get_my_glue_users(self, users_api, mock_client, sample_users_list_data):
    ...
    @pytest.mark.asyncio
    async def test_get_recently_active_users(self, users_api, mock_client, sample_users_list_data):
    ...
    @pytest.mark.asyncio
    async def test_get_top_reputation_users(self, users_api, mock_client, sample_users_list_data):
    ...
    @pytest.mark.asyncio
    async def test_get_user_statistics(self, users_api, mock_client, sample_users_list_data):
    ...
    @pytest.mark.asyncio
    async def test_search_users_with_email(self, users_api, mock_client, sample_user_data):
        """Test searching users with email query."""
        with patch.object(users_api, 'get_by_email', new_callable=AsyncMock) as mock_get_by_email:
            with patch.object(users_api, 'search_by_name', new_callable=AsyncMock) as mock_search_by_name:
    ...
    @pytest.mark.asyncio
    async def test_search_users_without_email(self, users_api, mock_client, sample_users_list_data):
    ...
    @pytest.mark.asyncio 
    async def test_search_users_duplicate_removal(self, users_api, mock_client, sample_user_data):
    ...
    async def test_get_admin_users(self, users_api, mock_client):
        ...
        with patch.object(users_api, 'filter_by_role', new_callable=AsyncMock) as mock_filter:
