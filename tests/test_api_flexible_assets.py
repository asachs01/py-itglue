...
class TestFlexibleAssetsAPI:
    ...
    async def test_get_by_organization(self, flexible_assets_api, mock_http_client, sample_collection_data):
    ...
    async def test_get_by_type(self, flexible_assets_api, mock_http_client, sample_collection_data):
    ...
    async def test_search_by_name(self, flexible_assets_api, mock_http_client, sample_collection_data):
        ...
        mock_http_client.get.assert_called_with("/flexible_assets", params=expected_params)
    ...
    async def test_search_by_trait(self, flexible_assets_api, mock_http_client, sample_collection_data):
        """Test searching flexible assets by trait."""
        mock_http_client.get.return_value = sample_collection_data
        
        # Test with value
        await flexible_assets_api.search_by_trait(
            trait_name="environment",
            trait_value="production",
            organization_id="456"
        )
        ...
        expected_params = {
            "filter[traits][hostname]": "*"
        }
        
        mock_http_client.get.assert_called_with("/flexible_assets", params=expected_params)
    
    async def test_search_by_tag(self, flexible_assets_api, mock_http_client, sample_collection_data):
        ...
        mock_http_client.get.assert_called_once_with("/flexible_assets", params=expected_params)
    
    async def test_list_by_status(self, flexible_assets_api, mock_http_client, sample_collection_data):
    ...
    async def test_get_active_assets(self, flexible_assets_api, mock_http_client, sample_collection_data):
    ...
    async def test_create_flexible_asset(self, flexible_assets_api, mock_http_client, sample_asset_data):
    ...
    async def test_update_traits(self, flexible_assets_api, mock_http_client, sample_asset_data):
        ...
        mock_http_client.patch.assert_called_once_with("/flexible_assets/123", expected_data)
        assert isinstance(result, FlexibleAsset)
    
    async def test_add_tags(self, flexible_assets_api, mock_http_client, sample_asset_data):
        ...
        expected_data = {
            "data": {
                "type": "flexible_assets",
                "attributes": {
                    "tag_list": ["production", "web", "critical"]
                }
            }
        }
    ...
    async def test_remove_tags(self, flexible_assets_api, mock_http_client, sample_asset_data):
    ...
    async def test_update_status(self, flexible_assets_api, mock_http_client, sample_asset_data):
        """Test updating flexible asset status."""
        mock_http_client.patch.return_value = sample_asset_data
        
        # Test with enum
        result = await flexible_assets_api.update_status("123", FlexibleAssetStatus.ARCHIVED)
...
class TestFlexibleAssetTypesAPI:
    ...
    async def test_get_enabled_types(self, flexible_asset_types_api, mock_http_client, sample_types_data):
    ...
    async def test_get_builtin_types(self, flexible_asset_types_api, mock_http_client, sample_types_data):
    ...
    async def test_search_by_name(self, flexible_asset_types_api, mock_http_client, sample_types_data):
        ...
        mock_http_client.get.assert_called_with("/flexible_asset_types", params=expected_params)
...
class TestFlexibleAssetFieldsAPI:
    ...
    async def test_get_by_type(self, flexible_asset_fields_api, mock_http_client, sample_fields_data):
    ...
    async def test_get_required_fields(self, flexible_asset_fields_api, mock_http_client, sample_fields_data):
    ...
    async def test_get_by_kind(self, flexible_asset_fields_api, mock_http_client, sample_fields_data):
        ...
        mock_http_client.get.assert_called_with("/flexible_asset_fields", params=expected_params)
        
        # Test with asset type filter
        await flexible_asset_fields_api.get_by_kind("Number", flexible_asset_type_id="123")
