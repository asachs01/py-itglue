    ...
    def test_relationship_properties(self):
        ...
        data = {
            ...
            "relationships": {
                ...
                "resource": {
                    "data": {"type": "configurations", "id": "789"}
                }
            }
        }
            ...
            "data": [
                {
                    ...
                    "attributes": {
                        ...
                        "favorite": True,
                        "archived": False,
                        "password-updated-at": (datetime.now(timezone.utc) - timedelta(days=15)).isoformat()
                    }
                },
                {
                    "id": "2",
                    ...
                    "attributes": {
                        ...
                        "favorite": False,
                        "archived": False,
                        "password-updated-at": (datetime.now(timezone.utc) - timedelta(days=100)).isoformat()
                    }
                },
                {
                    "id": "3",
                    ...
                    "attributes": {
                        ...
                        "favorite": False,
                        "archived": True,
                        "password-updated-at": (datetime.now(timezone.utc) - timedelta(days=200)).isoformat()
                    }
                }
            ]
        }
