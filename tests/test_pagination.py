...
class TestPaginationHandler:
    ...
    def test_parse_response_empty_data(self, pagination_handler):
        ...
        response_data = {
            'data': [],
            'meta': {'current-page': 1, 'total-count': 0}
        }
    ...
    def test_parse_response_invalid_format(self, pagination_handler):
        ...
        with pytest.raises(ITGlueAPIError, match="Invalid response format: expected dict"):
    ...
    def test_get_next_page_none_when_no_next(self, pagination_handler, mock_http_client):
    ...
    def test_get_all_pages(self, pagination_handler, mock_http_client):
        ...
        responses = [
            ...
            {
                'data': [{'id': '3'}, {'id': '4'}],
                'meta': {'current-page': 2, 'next-page': 3, 'prev-page': 1, 'total-pages': 3}
            },
            {
                'data': [{'id': '5'}],
