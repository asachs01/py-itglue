...
class Password(ITGlueResource):
    ...
    def is_high_security(self) -> bool:
        ...
        return self.password_category in [PasswordCategory.HIGH, PasswordCategory.CRITICAL]
    ...
    def is_organization_visible(self) -> bool:
        ...
        return self.visibility in [PasswordVisibility.ORGANIZATION, PasswordVisibility.EVERYONE]
...
class PasswordCollection(ITGlueResourceCollection[Password]):
    ...
    def filter_by_category(self, category: Union[PasswordCategory, str]) -> List[Password]:
    ...
    def filter_by_visibility(self, visibility: Union[PasswordVisibility, str]) -> List[Password]:
