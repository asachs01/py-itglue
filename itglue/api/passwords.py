...
from ..models.password import Password, PasswordCollection, PasswordCategory, PasswordVisibility, PasswordType
...
class PasswordsAPI(BaseAPI[Password]):
    ...
    async def filter_by_category(
        ...
        **params
        ...
        filter_params = {
            "filter[password-category-name]": category,
            **params
        }
    ...
    async def filter_by_type(
        ...
        **params
        ...
        filter_params = {
            "filter[password-type]": password_type,
            **params
        }
    ...
    async def get_critical_passwords(
        ...
        """
        return await self.filter_by_category(
    ...
    async def get_embedded_passwords(
        ...
        """
        return await self.filter_by_type(
            PasswordType.EMBEDDED, 
            organization_id
        )
    ...
    async def update_password_category(
        ...
        data = {
            "type": ResourceType.PASSWORDS.value,
            "attributes": {
                "password-category-name": category
            }
        }
    ...
    async def get_password_statistics(
        ...
        collection = PasswordCollection.from_api_dict({"data": [p.model_dump_api() for p in all_passwords]})
        ...
        stats["total_passwords"] = stats["active_passwords"] + stats["archived_passwords"]
    ...
    async def get_organization_password_report(
        ...
        recent_passwords = await self.get_recently_updated_passwords(30, organization_id)
        ...
        return {
            **stats,
            ...
            "security_recommendations": {
                ...
                "consider_upgrading_low_security": stats["security_distribution"].get("low", 0) > 0,
                "review_shared_passwords": stats["shared_passwords"] > stats["private_passwords"],
            }
        } 